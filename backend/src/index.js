...
app.post('/account/create', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let module_address;
    try {
        const safe = yield (0, safe_1.createSafe)(wallet, hardware_pub);
        safe_address = yield safe.getAddress();
        ...
        yield connection.execute('INSERT INTO user (hardware_pub, safe_address, verifier_address) VALUES (?, ?)', [hardware_pub, safe_address]);
